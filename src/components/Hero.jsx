...
export default function Hero({
    ...
    const defaultSubtitle = "Gold Medal Trout Waters on Colorado's iconic rivers. World-class redfish in the Louisiana marsh. Guided by Patrick Gerig — USCG-certified, 57 five-star reviews.";
